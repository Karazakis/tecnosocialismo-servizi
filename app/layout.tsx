...
export const metadata: Metadata = {
  ...
  description: "Servizi tecnici, salute, cura e didattica: online, a domicilio e nei luoghi della rete.",
  ...
  twitter: { card: "summary_large_image", title: "Servizi — Tecnosocialismo", description: "Tecnica, salute, cura e didattica in una rete di persone e luoghi.", images: ["/og.png"] },
};
